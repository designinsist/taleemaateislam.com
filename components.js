...
var SITE_SEARCH_INDEX = [
  ...
  { title: 'Dars-e-Quran', label: 'Quran', url: 'dars-e-quran.html', desc: 'Ayah-by-ayah Quran tafseer by Mufti Shahid Mushtaq - Surah Al-Anbiya, Surah Taha, Surah Maryam, Surah Al-Kahf, Surah Al-Isra, Baqarah, Yunus, Yousuf, Maidah, Al-Anam, Al-Anfal, Al-Araf, Al-Hijr, An-Nahal, Ar-Raad, At-Tauba, Hud, Ibrahim and more.', tags: 'dars quran tafseer mufti shahid mushtaq audio lecture ayah anbiya taha maryam kahf bani israel isra baqarah yunus yousuf maidah anam anfal araf hijr nahal raad tauba hud ibrahim explanation urdu' },
  { title: 'Dars-e-Quran Videos', label: 'Quran', url: 'dars-e-quran-videos.html', desc: 'Surah-based Dars-e-Quran YouTube videos by Mufti Shahid Mushtaq, including Al-Anbiya, Taha, Maryam, Al-Kahf, Al-Isra, and An-Nahal.', tags: 'dars quran videos youtube tafseer mufti shahid mushtaq surah anbiya taha maryam kahf isra bani israel nahal ayah playlist quran explanation urdu' },
  { title: 'Quran with Urdu Translation', label: 'Quran', url: 'quran-urdu-translation.html', desc: 'Quran passages with clear Urdu translation, beginning with selected verses from Surah Taha.', tags: 'quran urdu translation tarjuma قرآن مجید اردو ترجمہ surah taha verses taleemaat islam' },
...
(function () {
  ...
  const NAV_MAP = {
    ...
    'quran-urdu-translation.html' : 'quran-section',
    'jummah-khutbah.html'         : 'quran-section',
    'islamic-knowledge.html'      : 'quran-section',
  ...
  const BREADCRUMB_MAP = {
    ...
    'quran-urdu-translation.html': ['Quran & Dars', 'Quran Urdu Translation'],
    'jummah-khutbah.html': ['Quran & Dars', 'Jummah Khutbah'],
    'islamic-knowledge.html': ['Quran & Dars', 'Islamic Knowledge'],
