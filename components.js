...
var SITE_SEARCH_INDEX = [
  ...
  { title: 'Dars-e-Quran', label: 'Quran', url: 'dars-e-quran.html', desc: 'Ayah-by-ayah Quran tafseer by Mufti Shahid Mushtaq - Surah Taha, Surah Maryam, Surah Al-Kahf, Surah Al-Isra, Baqarah, Yunus, Yousuf, Maidah, Al-Anam, Al-Anfal, Al-Araf, Al-Hijr, An-Nahal, Ar-Raad, At-Tauba, Hud, Ibrahim and more.', tags: 'dars quran tafseer mufti shahid mushtaq audio lecture ayah taha maryam kahf bani israel isra baqarah yunus yousuf maidah anam anfal araf hijr nahal raad tauba hud ibrahim explanation urdu' },
  { title: 'Dars-e-Quran Videos', label: 'Quran', url: 'dars-e-quran-videos.html', desc: 'Surah-based Dars-e-Quran YouTube videos by Mufti Shahid Mushtaq, including Taha, Maryam, Al-Kahf, Al-Isra, and An-Nahal.', tags: 'dars quran videos youtube tafseer mufti shahid mushtaq surah taha maryam kahf isra bani israel nahal ayah playlist quran explanation urdu' },
